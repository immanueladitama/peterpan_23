          ...
          <h3 class="text-center"><strong> Sistem Peminjaman Ruangan UKDW</strong></h3>
            <p class="mb-4 text-center"><strong></strong></p>
              <div class="form-group first">
                ...
                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" @if(isset($email) AND isset($pass)) value="{{$email}}" @endif id="email" placeholder="" id="username" required autocomplete="email" autofocus>
              </div>
              <div class="form-group last mb-3">
                <label for="password" style="color: #ffff;">Password</label>
                <input type="password" class="form-control" placeholder="" id="password" name="password" @if(isset($email) AND isset($pass)) value="{{$pass}}" @endif required autocomplete="current-password">
              </div>
              
             

              <a href="/tambahruangan"><button type="submit"class="btn btn-danger btn-block">Log In</button></a>
              <br>
